...
//主机地址
define('DB_URL', '192.168.1.140');

//连接数据库的用户名
define('DB_USER', 'myuser');

//连接数据库的密码，推荐使用随机生成的字符串
define('DB_PASSWORD', 'Lj1314.-');

//数据库类型，用于PDO数据库连接
define('DB_TYPE', 'mysql');

//数据库名
define('DB_NAME', 'eo_api_store');

//数据库是否需要保持长期连接（长连接）,多线程高并发环境下请开启,默认关闭
define('DB_PERSISTENT_CONNECTION', FALSE);

//Redis地址
defined('REDIS_URL') or define('REDIS_URL', '120.24.235.6');

//Redis端口
defined('REDIS_PORT') or define('REDIS_PORT', '6379');

//Redis地址
defined('REDIS_REQUIREPASS') or define('REDIS_REQUIREPASS', 'Key123qaz:redis');
